...
Informe de Tarea 4: Circuitos en Serie-Paralelo; Teorema de Circuitos y Conversiones.

**2. OBJETIVO**

**2.1. Objetivo General:**

Aprender sobre los circuitos mixtos y sus características y los diversos teoremas que pueden aplicarse para su resolución.

**2.2. Objetivos Específicos:**

- Entender la relación que existen entre circuitos en serie y paralelos. 
- Aprender como interactuan las corrientes, voltajes y resistecias en un circuito mixto, y la aplicación de las leyes.
- Mirar para se utiliazan las conversiones de fuentes y en qué casos pueden ser útiles.
- Definir cada concepto y teorema para de esta manera lograr entender su funcionamientos y la forma adecuada de utilización.
